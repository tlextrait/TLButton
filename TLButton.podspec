...
Pod::Spec.new do |s|
  s.name             = 'TLButton'
  s.version          = '0.1.0'
  s.summary          = 'A short description of TLButton.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/TLButton'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Thomas Lextrait' => 'thomas.lextrait@gmail.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/TLButton.git', :tag => s.version.to_s }
